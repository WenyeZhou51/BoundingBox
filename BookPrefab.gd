...
func create_ui_elements():
	...
	content_label.text = """[color=green][font_size=20][center]BOOK[/center][/font_size]

[font_size=18]The mirror's temperature is always at zero

It is ice in your veins[/font_size][/color]"""
	content_label.visible = false
